...
class Settings(BaseSettings):
    ...
    ctrlx_opcua_url: str = "opc.tcp://192.168.17.60:4840"
    ...
    influx_token: str = "supersecrettoken"
    influx_org: str = "psi"
    influx_bucket_telemetry: str = "telemetry"
    influx_bucket_features: str = "features"
